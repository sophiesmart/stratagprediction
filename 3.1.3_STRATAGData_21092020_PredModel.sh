...
#######################################
#
#SBATCH --job-name=stratarepcvstudy
...
#SBATCH --output /nfshome/store02/users/c.mpmss1/STRATAG/logs/stratarepcvstudy_out.%J
#SBATCH --error /nfshome/store02/users/c.mpmss1/STRATAG/logs/stratarepcvstudy_err.%J
#SBATCH --mail-type=END
#SBATCH --mail-user=SMARTS1@cardiff.ac.uk
#

# 3.1.3_STRATAGData_21092020_PredModel.R
...
Rscript /nfshome/store02/users/c.mpmss1/STRATAG/3.1.2_STRATAGData_21092020_PredModel.R
...
#on Hawk\
#sbatch 3.1.3_STRATAGData_21092020_PredModel.sh
